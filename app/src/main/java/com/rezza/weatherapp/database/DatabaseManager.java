package com.rezza.weatherapp.database;
...
import com.rezza.weatherapp.BuildConfig;
...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "WEATHER_RZ.db";
